...
- **Neo4j** as the primary graph store: Cypher is the right query language for asking _"every function reachable from main"_. We make it optional via the storage adapter so dev doesn't need Docker.
